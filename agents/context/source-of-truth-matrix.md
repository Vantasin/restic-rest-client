...
| Bootstrap and setup flow | `bootstrap.sh`, `configure_env.sh`, `init_repo.sh`, `setup_password.sh`, `Makefile` | `Docs/BOOTSTRAP.md`, `Docs/RESTIC_ENV.md`, `Docs/SETUP_PASSWORD.md`, `Docs/MAKEFILE.md`, `README.md`, `Docs/RESTIC_REST_SERVER_SETUP.md` | `agents/context/bootstrap-and-setup.md` | `make verify`, `zsh -n bootstrap.sh`, `zsh -n configure_env.sh`, `zsh -n init_repo.sh`, `zsh -n setup_password.sh` |
