...
| Manual repository maintenance, log watching, and restore | `watch_backup_log.sh`, `unlock_stale_locks.sh`, `restore_latest.sh`, `Makefile` | `README.md`, `Docs/MAKEFILE.md`, `Docs/RUN_BACKUP_SCRIPT.md`, `Docs/RESTIC_RESTORE_README.md`, `Docs/BOOTSTRAP.md`, `Docs/RESTIC_REST_SERVER_SETUP.md` | `agents/context/repo-map.md`, `agents/context/run-backup.md` | `make verify`, `zsh -n watch_backup_log.sh`, `zsh -n unlock_stale_locks.sh`, `zsh -n restore_latest.sh` |
...
| Bootstrap and setup flow | `setup.sh`, `bootstrap.sh`, `install_and_watch.sh`, `configure_env.sh`, `init_repo.sh`, `setup_password.sh`, `Makefile` | `Docs/BOOTSTRAP.md`, `Docs/RESTIC_ENV.md`, `Docs/SETUP_PASSWORD.md`, `Docs/MAKEFILE.md`, `README.md`, `Docs/RESTIC_REST_SERVER_SETUP.md` | `agents/context/bootstrap-and-setup.md` | `make verify`, `zsh -n setup.sh`, `zsh -n bootstrap.sh`, `zsh -n install_and_watch.sh`, `zsh -n configure_env.sh`, `zsh -n init_repo.sh`, `zsh -n setup_password.sh` |
