...
| Env and config defaults | `restic.env.example`, `restic-repository.txt.example` | `Docs/RESTIC_ENV.md`, `Docs/RESTIC_REST_SERVER_SETUP.md`, `Docs/RESTIC_REST_SECURITY_MODEL.md` | `agents/context/config-and-templates.md`, `agents/context/rest-server-integration.md`, `agents/rules/template-integrity.md`, `agents/rules/client-server-boundaries.md` | `make verify` |
...
| Bootstrap and setup flow | `bootstrap.sh`, `setup_password.sh`, `Makefile` | `Docs/BOOTSTRAP.md`, `Docs/SETUP_PASSWORD.md`, `Docs/MAKEFILE.md`, `README.md` | `agents/context/bootstrap-and-setup.md` | `make verify`, `zsh -n bootstrap.sh`, `zsh -n setup_password.sh` |
